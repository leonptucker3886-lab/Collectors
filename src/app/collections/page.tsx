...
import { FiPlus, FiSearch, FiGrid, FiList, FiStar } from 'react-icons/fi';
  ...
  return (
    <div className="space-y-4 pb-20">
      <div className="sticky top-0 bg-[#0A0A0A] border-b border-[#1F1F1F] px-4 py-3 z-30">
        <h1 className="text-xl font-semibold mb-3">My Vault</h1>
      ...
      <div className="px-4">
        {needsPremium && !isPremium && (
          <div className="bg-gradient-to-r from-[#C0A080]/20 to-transparent rounded-xl p-4 border border-[#C0A080]/30 mb-4">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <h3 className="font-medium text-[#C0A080]">Premium Vault</h3>
                <p className="text-xs text-[#666]">Upgrade to add more collections</p>
              </div>
              <button
        ...
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center p-4 z-50">
          <div className="bg-[#141414] rounded-2xl p-6 max-w-sm w-full border border-[#2A2A2A]">
            <div className="text-center mb-6">
              ...
              <p className="text-[#666] text-sm">Unlock unlimited collections.</p>
            </div>
